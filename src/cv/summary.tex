...
\begin{cventries}
    {
        ...
        % \end{chronology}
        \begin{chronology}[3]{2007}{2018}{0.75\textwidth}[\textwidth]
            %Milestones
            ...
            \event{\decimaldate{1}{9}{2013}}{\descriptionstyle{Indian Delivery Center on boarding}}
